...
Handlebars.registerPartial("pageHead", Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<head>\n  <title>"
    ...
    + ((stack1 = container.invokePartial(partials.socialSharing,depth0,{"name":"socialSharing","data":data,"indent":"\t","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
...
Handlebars.registerPartial("socialSharing", Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
...
this["lg"]["templates"]["socialSharing"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<!-- Pinterest -->\n<script\n    type=\"text/javascript\"\n    async defer\n    src=\"//assets.pinterest.com/js/pinit.js\"\n></script>\n";
},"useData":true});